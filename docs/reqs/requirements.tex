	...
	\item
		...
		\begin{enumerate}
			...
			\item
				...
				\end{enumerate}
			\item
				The UI shall contain a games section
				\begin{enumerate}
					\item
						The UI shall provide a game select screen for the user to select from the application's games
						\begin{enumerate}
							\item
						...
						\end{enumerate}
					\item
						The UI shall provide a game options screen for user to configure the game parameters
						\begin{enumerate}
							\item
